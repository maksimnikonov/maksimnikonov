package sef.ATestTask.FirstActivity;public class Employee extends Person {
    ...
    public Employee( int empId,String jobTitle,String companyName,double salary){this.empId=empId;
